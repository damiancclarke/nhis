...
local dat_name "$DAT/1997/familyxx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$OUT/1997/familyxx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$COD/1997/nhis1997_familyxx.dct"
...
label define fssiyn  
	...
	9           "Don't know"                    
;
label values fssdiyn  fssdiyn;
label define fssdiyn 
	1           "Yes"                           
	2           "No"                            
	7           "Refused"                       
	8           "Not ascertained"               
	9           "Don't know"                    
;
label values fafdcyn  fafdcyn;
label define fafdcyn 
	1           "Yes"                           
	2           "No"                            
	7           "Refused"                       
	8           "Not ascertained"               
