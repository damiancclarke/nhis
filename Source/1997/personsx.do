...
correcting erroneous quotation marks, and adding a numeric variable "fmprflg1"
in place of the originally excluded string "fmprflg."
*/
...
local dat_name "~/database/NHIS/Data/raw/1997/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "~/database/NHIS/Data/dta/1997/personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$COD/nhis1997_personsx.dct"
