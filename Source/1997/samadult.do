...
correcting erroneous quotation marks.
*/

/*------------------------------------------------
  This program reads the 1997 National Health Interview Survey 1997 samadult  Data File
  by Jean Roth Mon Jul  2 15:42:24 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do nhis1997_samadult
----------------------------------------------- */
...
local dat_name "~/database/NHIS/Data/raw/1997/samadult.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "~/database/NHIS/Data/dta/1997/samadult"

/* The following line should contain the path to the data dictionary file */

local dct_name "$COD/nhis1997_samadult.dct"
