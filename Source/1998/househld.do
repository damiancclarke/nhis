...
/*------------------------------------------------
  This program reads the 1998 National Health Interview Survey 1998 househld  Data File
  by Jean Roth Mon Jul  2 15:42:31 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do nhis1998_househld
----------------------------------------------- */
...
local dat_name "~/database/NHIS/Data/raw/1998/househld.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "~/database/NHIS/Data/dta/1998/househld"

/* The following line should contain the path to the data dictionary file */

local dct_name "$COD/nhis1998_househld.dct"
