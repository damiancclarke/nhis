...
deleting erroneous quotation marks, and fixing the variables "parents" and "guard."
*/

/*------------------------------------------------
  This program reads the 1998 National Health Interview Survey 1998 samchild  Data File
  by Jean Roth Mon Jul  2 15:43:05 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do nhis1998_samchild
----------------------------------------------- */
...
label define msasizep
	...
	7           "Non-MSA"                       
;
label values dummy_cp dummy_cp;
label define dummy_cp
	1           "Dummy record"                  
