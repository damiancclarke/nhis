...
/*------------------------------------------------
  This program reads the 2001 National Health Interview Survey 2001 househld  Data File
  by Jean Roth Mon Jul  2 15:41:40 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do nhis2001_househld
----------------------------------------------- */
...
local dat_name "~/database/NHIS/Data/raw/2001/househld.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "~/database/NHIS/Data/dta/2001/househld"

/* The following line should contain the path to the data dictionary file */

local dct_name "$COD/nhis2001_househld.dct"
