...
*********************************************************************
 ...
 FILE FROM THE 2004 NHIS Public Use Household ASCII FILE
...
label variable non_intv "MHH.000_00.000.R01: Category of type A non-response";
label variable acpt_fam "MHH.000_00.000.R04: Number of families responding in HH
";
label variable rej_fam  "
MHH.000_00.000.R05: Number of families not responding in HH";
label variable acpt_per "MHH.000_00.000.R06: Number of persons responding in HH
";
label variable rej_per  "
MHH.000_00.000.R07: Number of persons not responding in HH";
label variable acptchld "
MHH.000_00.000.R08: Number of children that responded in HH*";

label variable region   "UCF.000_00.000.R09: Region";
...
save "$OUT/2004/househld", replace;
