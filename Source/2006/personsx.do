...
*********************************************************************
 ...
 FILE FROM THE 2006 NHIS Public Use Person ASCII FILE
...
FHS.270_09.000: Other mental/emot/behav problem causes limitation";
...
label variable lahca32_ "FHS.350_18.000: 'Old age'/elderly/aging-related problem
";
...
FHS.398_01.000 RECOD: Duration of circulatory problem: Number of units";
label variable launit21 "
FHS.398_02.000 RECOD: Duration of circulatory problem: Time unit";
...
FHS.452_02.000: Chronic condition recode for person with lim of activ";
...
label define pep375x
   1        "1 At least one condition causing lim of activ is chronic"
   2        "2 No condition causing lim of activ is chronic"
   9        "9 Unk if any condition causing lim of activ is chronic"
;
...
label values plnmgd1   pep428x;   label values mgchmd1   pep429x;
...
label values mgchmd2   pep429x;   label values mgprmd2   pep037x;
...
label values milspc4   pep069x;   label values milman    pep469x;
label values ihs       pep037x;   label values hilast    pep471x;
...
label values hinotmyr  pep384x;   label values hcspfyr   pep489x;
label values hikinda   pep069x;   label values hikindb   pep069x;
label values hikindc   pep069x;   label values hikindd   pep069x;
label values hikinde   pep069x;   label values hikindf   pep069x;
label values hikindg   pep069x;   label values hikindh   pep069x;
label values hikindi   pep069x;   label values hikindj   pep069x;
label values hikindk   pep069x;   label values mcareprb  pep037x;
label values mcaidprb  pep037x;   label values sincov    pep037x;

label values plborn    pep037x;   label values regionbr  pep505x;
label values geobrth   pep506x;   label values yrsinus   pep507x;
label values citizenp  pep508x;   label values headst    pep037x;
label values headstv1  pep037x;   label values educ1     pep511x;
label values pmiltry   pep037x;   label values doinglwp  pep513x;
label values whynowkp  pep514x;   label values wrkhrs2   pep515x;
label values wrkftall  pep037x;   label values wrklyr1   pep037x;
label values wrkmyr    pep518x;   label values ernyr_p   pep519x;
label values hiempof   pep037x;

label values psal      pep037x;   label values pseinc    pep037x;
label values pssrr     pep037x;   label values pssrrdb   pep037x;
label values pssrrd    pep037x;   label values ppens     pep037x;
label values popens    pep037x;   label values pssi      pep037x;
label values pssid     pep037x;   label values ptanf     pep037x;
label values powben    pep037x;   label values pintrstr  pep037x;
label values pdivd     pep037x;   label values pchldsp   pep037x;
label values pincot    pep037x;   label values pssapl    pep037x;
label values psdapl    pep037x;   label values tanfmyr   pep384x;
label values pfstp     pep037x;   label values fstpmyr   pep384x;
label values eligpwic  pep541x;   label values pwic      pep037x;
label values wic_flag  pep543x;
